(() => {
  ...
  function loadPicture(id) {
    return fetch(config_default.URL + "/photos/" + id).then((response) => {
      if (response.ok)
  ...
  function displayPicture(picture) {
    ...
    let templateCompiled = import_handlebars.default.compile(template);
    picture.url.href = config_default.domain + picture.url.href;
  ...
  function getPicture(id) {
    return __async(this, null, function* () {
      let res = yield photoloader_default.loadPicture(id);
      console.log(res);
